...
function LoginScreen() {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", padding: "40px 24px", textAlign: "center", background: "#F5F0EB" }}>
      ...
      <p style={{ fontSize: "12px", color: "#9C8E82", marginTop: "28px", maxWidth: "280px", lineHeight: 1.55 }}>Connect your personal and business Gmail accounts. Your emails are processed securely.</p>
    </div>
  );
}
